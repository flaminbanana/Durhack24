...
Dict = csvToDict.csvToDict('scrapedData/londonAttractions.csv')
Name = [item['name'] for item in Dict]
Name = [item + ' London UK' for item in Name]
...
with open('scrapedData/londonAttractions.csv', 'w', newline='') as file:
