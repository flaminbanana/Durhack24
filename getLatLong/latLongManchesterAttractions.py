...
Dict = csvToDict.csvToDict('scrapedData/manchesterAttractions.csv')
Name = [item['name'] for item in Dict]
Name = [item + ' Manchester UK' for item in Name]
...
with open('scrapedData/manchesterAttractions.csv', 'w', newline='') as file:
